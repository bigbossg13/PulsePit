...
export default function CopyButton({ text }: { text: string }) {
  ...
  return (
    <button
      ...
      className="absolute right-3 top-3 rounded-md bg-gray-700 hover:bg-gray-600 px-2.5 py-1 text-xs text-gray-200 transition-colors flex items-center gap-1.5"
    >
      {copied ? (
        <>
